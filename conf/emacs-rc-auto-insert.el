...
(setq auto-insert-alist '(("\\.sh$" . ["insert.sh" alexott/auto-update-defaults])
                          ("\\.cpp$" . ["insert.cpp" alexott/auto-update-c-source-file])
                          ("\\.cc" . ["insert.cpp" alexott/auto-update-c-source-file])
                          ("\\.c$" . ["insert.c" alexott/auto-update-c-source-file])
                          ("\\.h$"   . ["insert.h" alexott/auto-update-header-file])
                          ("\\.hpp$"   . ["insert.h" alexott/auto-update-header-file])
                          ))
